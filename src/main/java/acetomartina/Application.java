...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        CarloDAO carloDAO = new CarloDAO(entityManager);
        ...
        DataSeeder.riempiUtenti(utenteDAO,carloDAO);
        ...
        PuntoEmissione pe4 = new PuntoEmissione(TipoPuntoEmissione.DISTRIBUTORE, false);
        ...
        PuntoEmissione pe9 = new PuntoEmissione(TipoPuntoEmissione.RIVENDITORE, false);
